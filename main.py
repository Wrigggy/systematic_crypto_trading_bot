...
STRATEGY_PROFILES: dict[str, dict] = {
    ...
    "core_satellite_rotation_v1": {
        ...
        "strategy": {
            ...
            "use_model_overlay": False,
            "position_size_pct": 0.040,
            "base_size_pct": 0.012,
            "max_size_pct": 0.050,
            "kelly_fraction": 0.22,
            "estimated_win_rate": 0.55,
            "estimated_payoff": 1.28,
            "confirmation_bars": 3,
            "min_entry_score": 0.72,
            "max_blocker_score": 0.20,
            "min_exit_score": 0.36,
            ...
            "exit_horizon_minutes": 20,
            "base_stop_loss_pct": 0.007,
            "take_profit_1_rr": 0.9,
            "take_profit_2_rr": 1.7,
            ...
            "max_taker_ratio": 1.06,
            "max_open_interest_change": 0.012,
            "open_interest_lookback_samples": 60,
            "max_volatility": 0.018,
            "enable_turtle_breakout_entry": True,
            "turtle_min_breakout_distance": 0.18,
            "turtle_max_breakout_distance": 1.05,
            "turtle_min_volume_ratio": 1.02,
            "turtle_trend_slack": 0.90,
            "turtle_min_rsi": 52.0,
            "turtle_max_rsi": 72.0,
            "enable_grid_reversion_entry": True,
            "enable_overextension_exit": True,
            "grid_reversion_min_breakout_distance": -0.28,
            "grid_reversion_max_breakout_distance": 0.06,
            "grid_reversion_target_breakout_distance": -0.08,
            "grid_reversion_min_rsi": 44.0,
            "grid_reversion_max_rsi": 57.0,
            ...
            "grid_reversion_max_volume_ratio": 1.25,
            "grid_reversion_short_vol_ratio_max": 1.00,
            "grid_reversion_trend_slack": 0.80,
            "overextension_min_breakout_distance": 0.62,
            "overextension_min_rsi": 72.0,
            "overextension_min_volume_zscore": 0.15,
            "overextension_min_taker_ratio": 1.04,
            "core_symbols": [
                "BTC/USDT",
                "ETH/USDT",
                "SOL/USDT",
            ...
            "factor_icir_window": 120,
            "factor_icir_min_samples": 30,
            "factor_icir_min_lambda": 0.35,
            "factor_icir_tau": 60.0,
            "factor_icir_weight_floor": 0.85,
            "factor_icir_weight_ceiling": 1.15,
            "onchain_stale_days_max": 10.0,
            "onchain_mvrv_bullish_max": 0.95,
            "onchain_mvrv_bearish_min": 2.20,
            "onchain_activity_lookback": 14,
            "onchain_activity_bullish_growth": 0.18,
            "onchain_activity_bearish_growth": -0.18,
            "onchain_nvt_proxy_lookback": 30,
            "onchain_nvt_proxy_bullish_zscore": -1.00,
            "onchain_nvt_proxy_bearish_zscore": 1.50,
            "onchain_ecosystem_lookback": 14,
            "onchain_ecosystem_bullish_growth": 0.12,
            "onchain_ecosystem_bearish_growth": -0.12,
            "allow_satellite_in_neutral": True,
            "top_n_entries_per_cycle": 1,
            "max_active_positions": 2,
            "satellite_max_active_positions": 0,
            "satellite_min_entry_score_bonus": 0.0,
            "core_priority_bonus": 0.0,
            "portfolio_targeting_enabled": True,
            "portfolio_rank_weight_power": 1.20,
            "portfolio_max_rank_size_multiplier": 1.10,
            "relative_strength_enabled": False,
            "relative_strength_lookback_bars": 36,
            "relative_strength_vol_window": 72,
            "relative_strength_vol_percentile": 0.80,
            "relative_strength_weight": 0.08,
            "relative_strength_weak_penalty": 0.05,
            "relative_strength_min_score": -0.15,
            "volume_weighted_momentum_enabled": False,
            "volume_momentum_short_window": 6,
            "volume_momentum_long_window": 24,
            "volume_ratio_cap": 2.5,
            "volume_weighted_momentum_weight": 0.0,
            "volume_weighted_momentum_min_score": -999.0,
            "candidate_cohort_gate_enabled": True,
            "no_trade_min_candidate_score": 0.66,
            "no_trade_min_score_margin": 0.04,
            "symbol_performance_enabled": True,
            "symbol_performance_window": 8,
            "symbol_performance_min_trades": 3,
            "bayesian_symbol_performance_enabled": True,
            "bayesian_symbol_prior_mean": 0.0,
            "bayesian_symbol_prior_strength": 6.0,
            "bayesian_symbol_observation_strength": 1.5,
            "bayesian_symbol_uncertainty_penalty": 1.25,
            "symbol_performance_weight": 0.10,
            "core_underperformance_penalty": 0.02,
            "satellite_underperformance_penalty": 0.00,
            "core_underperformance_threshold": -0.012,
            "satellite_underperformance_threshold": 0.00,
            "factor_weights": {
                "market_regime": 0.20,
                "trend_alignment": 0.22,
                "momentum_impulse": 0.08,
                "breakout_confirmation": 0.08,
                "turtle_breakout_entry": 0.20,
                "grid_reversion_entry": 0.16,
                "overextension_exit": 0.12,
                "onchain_mvrv_state": 0.04,
                "onchain_activity_state": 0.03,
                "onchain_nvt_proxy": 0.02,
                "onchain_ecosystem_state": 0.03,
        ...
        "regime": {
            ...
            "mode": "per_symbol",
            "benchmark_symbols": [],
            "risk_on_threshold": 0.26,
            "neutral_threshold": 0.10,
            "breadth_min_symbols": 0,
            "volatility_ceiling": 0.018,
        },
        "trend": {
            "breakout_lookback": 24,
            "trend_slope_lookback": 24,
            ...
            "breakout_overheat_distance": 1.10,
            "min_trend_slope": 0.0006,
            "min_volume_zscore": -0.02,
            "vol_target_floor": 0.011,
        },
        "risk": {
            ...
            "break_even_trigger_pct": 0.012,
            "break_even_buffer_pct": 0.0015,
            "bayesian_volatility_enabled": True,
            "bayesian_volatility_prior_mean": 0.011,
            "bayesian_volatility_prior_strength": 18.0,
            "bayesian_volatility_observation_strength": 4.0,
            "bayesian_volatility_window": 96,
            "bayesian_volatility_uncertainty_penalty": 1.75,
            "bayesian_volatility_target": 0.011,
            "bayesian_volatility_min_size_multiplier": 0.30,
            "bayesian_volatility_max_size_multiplier": 1.15,
            "bayesian_volatility_min_single_exposure_multiplier": 0.40,
            "bayesian_volatility_max_single_exposure_multiplier": 1.05,
            "bayesian_volatility_min_portfolio_exposure_multiplier": 0.55,
            "bayesian_volatility_max_portfolio_exposure_multiplier": 1.05,
            "bayesian_volatility_min_stop_multiplier": 0.90,
            "bayesian_volatility_max_stop_multiplier": 1.35,
        },
    },
    "regime_trend_v1": {
        "alpha": {
    ...
    "stable_swing_t_v1": {
        ...
        "strategy": {
            "profile": "stable_swing_t_v1",
            "use_model_overlay": False,
            "position_size_pct": 0.010,
            "base_size_pct": 0.0025,
            "max_size_pct": 0.0075,
            "kelly_fraction": 0.08,
            "estimated_win_rate": 0.56,
            "estimated_payoff": 1.15,
            "confirmation_bars": 3,
            "post_exit_cooldown_minutes": 120,
            "min_entry_score": 0.70,
            "max_blocker_score": 0.16,
            "min_exit_score": 0.30,
            "neutral_entry_size_multiplier": 0.0,
            ...
            "max_open_interest_change": 0.010,
            "max_volatility": 0.013,
            "core_symbols": ["BTC/USDT", "SOL/USDT"],
            "satellite_symbols": [],
            ...
            "portfolio_targeting_enabled": False,
            "relative_strength_enabled": False,
    ...
    "stable_swing_t_v2": {
        ...
        "strategy": {
            ...
            "estimated_payoff": 1.20,
            "confirmation_bars": 3,
            "post_exit_cooldown_minutes": 150,
            "min_entry_score": 0.72,
            "max_blocker_score": 0.14,
            "min_exit_score": 0.40,
            "neutral_entry_size_multiplier": 0.0,
            "risk_off_entry_size_multiplier": 0.0,
            "min_volatility_size_multiplier": 0.08,
            "require_trend_alignment": True,
            "min_supporting_factors": 4,
            "min_supporting_categories": 3,
            "urgent_entry_score": 0.90,
            ...
            "base_stop_loss_pct": 0.005,
            "take_profit_1_rr": 0.9,
            "take_profit_2_rr": 1.6,
            "enable_pullback_reentry": True,
            "enable_overextension_exit": True,
            "pullback_min_breakout_distance": -0.32,
            "pullback_max_breakout_distance": 0.08,
            "pullback_target_breakout_distance": -0.07,
            "pullback_min_rsi": 46.0,
            "pullback_max_rsi": 57.0,
            "pullback_target_rsi": 52.0,
            "pullback_min_momentum": -0.005,
            "pullback_max_momentum": 0.004,
            "pullback_min_volume_ratio": 0.95,
            "pullback_trend_slack": 0.88,
            "overextension_min_breakout_distance": 0.55,
            "overextension_min_rsi": 70.0,
            "overextension_min_volume_zscore": 0.10,
            "overextension_min_taker_ratio": 1.03,
            "min_volume_ratio": 1.08,
            "min_order_book_imbalance": 1.03,
            "max_funding_rate": 0.00020,
            "max_taker_ratio": 1.03,
            "max_open_interest_change": 0.008,
            ...
            "factor_weights": {
                ...
                "momentum_impulse": 0.05,
                "breakout_confirmation": 0.05,
                "pullback_reentry": 0.22,
                "overextension_exit": 0.14,
                "volume_confirmation": 0.10,
                "liquidity_balance": 0.08,
                "perp_crowding": 0.16,
                "volatility_regime": 0.16,
            },
        },
        "regime": {
            "enabled": True,
            ...
            "neutral_threshold": 0.12,
            "breadth_min_symbols": 2,
            "volatility_ceiling": 0.013,
        },
        "trend": {
            "breakout_lookback": 24,
            "trend_slope_lookback": 24,
            "volume_zscore_window": 24,
            "breakout_min_distance": 0.20,
            "breakout_overheat_distance": 1.00,
            "min_trend_slope": 0.00078,
            "min_volume_zscore": 0.00,
            "vol_target_floor": 0.0085,
        },
        "risk": {
            "max_portfolio_exposure": 0.035,
            "max_single_exposure": 0.012,
            "trailing_stop_pct": 0.014,
            "atr_stop_multiplier": 1.35,
            "daily_drawdown_limit": 0.010,
            "max_orders_per_minute": 2,
            "break_even_trigger_pct": 0.010,
            "break_even_buffer_pct": 0.0010,
        },
    },
    "stable_swing_t_v2_guarded": {
        "symbols": [
            "BTC/USDT",
            "ETH/USDT",
        ],
        ...
        "strategy": {
            "profile": "stable_swing_t_v2_guarded",
            "use_model_overlay": False,
            "position_size_pct": 0.012,
            "base_size_pct": 0.003,
            "max_size_pct": 0.009,
            ...
            "satellite_symbols": ["ETH/USDT"],
            "allow_satellite_in_neutral": False,
            "top_n_entries_per_cycle": 1,
            "max_active_positions": 1,
            "satellite_max_active_positions": 1,
            "satellite_min_entry_score_bonus": 0.05,
            "core_priority_bonus": 0.04,
            "portfolio_targeting_enabled": False,
            "relative_strength_enabled": True,
            "relative_strength_lookback_bars": 36,
            "relative_strength_vol_window": 72,
            "relative_strength_vol_percentile": 0.75,
            "relative_strength_weight": 0.12,
            "relative_strength_weak_penalty": 0.08,
            "relative_strength_min_score": -0.03,
            "volume_weighted_momentum_enabled": False,
            "candidate_cohort_gate_enabled": False,
            "symbol_performance_enabled": True,
            "symbol_performance_window": 6,
            "symbol_performance_min_trades": 2,
            "symbol_performance_weight": 0.06,
            "core_underperformance_penalty": 0.01,
            "satellite_underperformance_penalty": 0.08,
            "core_underperformance_threshold": -0.01,
            "satellite_underperformance_threshold": 0.0,
            "factor_weights": {
                "market_regime": 0.30,
                "trend_alignment": 0.28,
                "momentum_impulse": 0.05,
    ...
    "stable_swing_t_v3": {
        ...
        "strategy": {
            "profile": "stable_swing_t_v3",
            "use_model_overlay": False,
            "position_size_pct": 0.014,
            "base_size_pct": 0.0035,
            "max_size_pct": 0.010,
            "kelly_fraction": 0.11,
            "estimated_win_rate": 0.59,
            "estimated_payoff": 1.22,
            "confirmation_bars": 3,
            "post_exit_cooldown_minutes": 120,
            "min_entry_score": 0.71,
            "max_blocker_score": 0.16,
            "min_exit_score": 0.40,
            "neutral_entry_size_multiplier": 0.0,
            "risk_off_entry_size_multiplier": 0.0,
            "min_volatility_size_multiplier": 0.10,
            "require_trend_alignment": True,
            "min_supporting_factors": 4,
            "min_supporting_categories": 3,
            "urgent_entry_score": 0.88,
            ...
            "enable_grid_reversion_entry": True,
            "enable_overextension_exit": True,
            "pullback_min_breakout_distance": -0.34,
            "pullback_max_breakout_distance": 0.10,
            "pullback_target_breakout_distance": -0.08,
            "pullback_min_rsi": 45.0,
            "pullback_max_rsi": 58.0,
            "pullback_target_rsi": 51.0,
            "pullback_min_momentum": -0.006,
            "pullback_max_momentum": 0.005,
            "pullback_min_volume_ratio": 0.90,
            "pullback_trend_slack": 0.85,
            "vol_compression_min_breakout_distance": -0.02,
            "vol_compression_max_breakout_distance": 0.22,
            "vol_compression_min_rsi": 50.0,
            "vol_compression_max_rsi": 64.0,
            "vol_compression_short_vol_ratio_max": 0.82,
            "vol_compression_min_volume_ratio": 0.78,
            "vol_compression_max_volume_ratio": 1.08,
            "vol_compression_trend_slack": 0.90,
            "grid_reversion_min_breakout_distance": -0.24,
            "grid_reversion_max_breakout_distance": 0.03,
            "grid_reversion_target_breakout_distance": -0.08,
            "grid_reversion_min_rsi": 46.0,
            "grid_reversion_max_rsi": 55.0,
            "grid_reversion_target_rsi": 50.0,
            "grid_reversion_min_momentum": -0.005,
            "grid_reversion_max_momentum": 0.003,
            "grid_reversion_min_volume_ratio": 0.82,
            "grid_reversion_max_volume_ratio": 1.18,
            "grid_reversion_short_vol_ratio_max": 0.98,
            "grid_reversion_trend_slack": 0.82,
            "overextension_min_breakout_distance": 0.58,
            "overextension_min_rsi": 71.0,
            "overextension_min_volume_zscore": 0.10,
            "overextension_min_taker_ratio": 1.03,
            ...
            "max_active_positions": 1,
            "satellite_max_active_positions": 1,
            "satellite_min_entry_score_bonus": 0.06,
            "core_priority_bonus": 0.04,
            "portfolio_targeting_enabled": False,
            "relative_strength_enabled": True,
            "relative_strength_lookback_bars": 36,
            ...
            "volume_momentum_long_window": 24,
            "volume_ratio_cap": 2.5,
            "volume_weighted_momentum_weight": 0.06,
            "volume_weighted_momentum_min_score": -0.02,
            "candidate_cohort_gate_enabled": True,
            "no_trade_min_candidate_score": 0.73,
            "no_trade_min_score_margin": 0.015,
            "symbol_performance_enabled": True,
            "symbol_performance_window": 6,
            "symbol_performance_min_trades": 2,
            "symbol_performance_weight": 0.12,
            "core_underperformance_penalty": 0.02,
            "satellite_underperformance_penalty": 0.10,
            "core_underperformance_threshold": -0.008,
            "satellite_underperformance_threshold": 0.0,
            "factor_weights": {
                "market_regime": 0.28,
                "trend_alignment": 0.26,
                "momentum_impulse": 0.04,
                "breakout_confirmation": 0.04,
                "pullback_reentry": 0.16,
                "volatility_compression_entry": 0.12,
                "grid_reversion_entry": 0.10,
                "overextension_exit": 0.12,
                "volume_confirmation": 0.10,
                "liquidity_balance": 0.08,
                "perp_crowding": 0.16,
        ...
        "trend": {
            ...
            "volume_zscore_window": 24,
            "breakout_min_distance": 0.18,
            "breakout_overheat_distance": 1.05,
            "min_trend_slope": 0.00075,
            "min_volume_zscore": -0.02,
            "vol_target_floor": 0.0085,
        },
        "risk": {
            "max_portfolio_exposure": 0.040,
            "max_single_exposure": 0.014,
            "trailing_stop_pct": 0.014,
    ...
    "stable_swing_t_v3_lstm": {
        ...
        "alpha": {
            "engine": "ensemble",
            "model_type": "lstm",
            "model_path": str((PROJECT_ROOT / "artifacts" / "model.pt").resolve()),
            "seq_len": 240,
            "resample_minutes": 5,
            "multi_timeframes": [15, 60],
        },
        "strategy": {
            "profile": "stable_swing_t_v3_lstm",
            ...
            "estimated_payoff": 1.22,
            "confirmation_bars": 3,
            "post_exit_cooldown_minutes": 105,
            "min_entry_score": 0.70,
            "max_blocker_score": 0.16,
            "min_exit_score": 0.40,
            "neutral_entry_size_multiplier": 0.0,
            ...
            "take_profit_1_rr": 0.9,
            "take_profit_2_rr": 1.7,
            "model_filter_threshold": 0.08,
            "model_exit_threshold": -0.12,
            "model_size_weight": 0.10,
            "enable_pullback_reentry": True,
            "enable_volatility_compression_entry": True,
            "enable_grid_reversion_entry": True,
            "enable_overextension_exit": True,
            ...
            "max_active_positions": 1,
            "satellite_max_active_positions": 1,
            "satellite_min_entry_score_bonus": 0.07,
            "core_priority_bonus": 0.04,
            "portfolio_targeting_enabled": False,
            "relative_strength_enabled": True,
            "relative_strength_lookback_bars": 36,
            ...
            "relative_strength_weight": 0.16,
            "relative_strength_weak_penalty": 0.08,
            "relative_strength_min_score": -0.02,
            "volume_weighted_momentum_enabled": True,
            "volume_momentum_short_window": 6,
            "volume_momentum_long_window": 24,
            "volume_ratio_cap": 2.5,
            "volume_weighted_momentum_weight": 0.06,
            "volume_weighted_momentum_min_score": -0.01,
            "candidate_cohort_gate_enabled": True,
            "no_trade_min_candidate_score": 0.72,
            "no_trade_min_score_margin": 0.010,
            "symbol_performance_enabled": True,
            "symbol_performance_window": 6,
            "symbol_performance_min_trades": 2,
            "symbol_performance_weight": 0.12,
            "core_underperformance_penalty": 0.02,
            "satellite_underperformance_penalty": 0.12,
            "core_underperformance_threshold": -0.008,
            "satellite_underperformance_threshold": 0.0,
            "factor_weights": {
                "market_regime": 0.28,
    ...
    "stable_swing_t_v3_lstm_mainstream": {
        "symbols": [
            "BTC/USDT",
            "ETH/USDT",
            "SOL/USDT",
        ...
        "strategy": {
            "profile": "stable_swing_t_v3_lstm_mainstream",
            "use_model_overlay": True,
            "position_size_pct": 0.014,
            "base_size_pct": 0.0035,
            "max_size_pct": 0.010,
            ...
            "satellite_symbols": ["BNB/USDT", "LINK/USDT"],
            "allow_satellite_in_neutral": False,
            "top_n_entries_per_cycle": 1,
            "max_active_positions": 1,
            "satellite_max_active_positions": 1,
            "satellite_min_entry_score_bonus": 0.12,
            ...
            "volume_weighted_momentum_min_score": 0.01,
            "candidate_cohort_gate_enabled": True,
            "no_trade_min_candidate_score": 0.76,
            "no_trade_min_score_margin": 0.015,
            "symbol_performance_enabled": True,
            "symbol_performance_window": 6,
            "symbol_performance_min_trades": 2,
            "symbol_performance_weight": 0.12,
            "core_underperformance_penalty": 0.02,
            "satellite_underperformance_penalty": 0.14,
            "core_underperformance_threshold": -0.008,
            "satellite_underperformance_threshold": 0.0,
            "factor_weights": {
                "market_regime": 0.28,
...
STRATEGY_PROFILES["core_satellite_rotation_v1_best_20260325"] = copy.deepcopy(
    STRATEGY_PROFILES["core_satellite_rotation_v1"]
)
_best_20260325 = STRATEGY_PROFILES["core_satellite_rotation_v1_best_20260325"]
_best_20260325["strategy"]["profile"] = "core_satellite_rotation_v1_best_20260325"
_best_20260325["strategy"]["dynamic_entry_factor_weight_targets"] = [
    factor
    for factor in _best_20260325["strategy"]["dynamic_entry_factor_weight_targets"]
    if factor != "onchain_ecosystem_state"
]
_best_20260325["strategy"]["factor_icir_targets"] = [
    factor
    for factor in _best_20260325["strategy"]["factor_icir_targets"]
    if factor != "onchain_ecosystem_state"
]
_best_20260325["strategy"]["factor_weights"]["onchain_ecosystem_state"] = 0.0
